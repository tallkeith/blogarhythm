...
class TimelinesControllerTest < ActionController::TestCase
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post :create, timeline: { dateofimage: @timeline.dateofimage, imageurl: @timeline.imageurl, likes: @timeline.likes, numcomments: @timeline.numcomments, shares: @timeline.shares, sourceofimage: @timeline.sourceofimage, user_id: @timeline.user_id }
    end
  ...
  test "should update timeline" do
    patch :update, id: @timeline, timeline: { dateofimage: @timeline.dateofimage, imageurl: @timeline.imageurl, likes: @timeline.likes, numcomments: @timeline.numcomments, shares: @timeline.shares, sourceofimage: @timeline.sourceofimage, user_id: @timeline.user_id }
    assert_redirected_to timeline_path(assigns(:timeline))
  end
